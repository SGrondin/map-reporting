...
(function() {
  ...
  exports.Node = (function() {
    ...
    Node.prototype.toString = function(indent) {
      ...
      if (this.type === "path" && (this.attributes.name != null)) {
        this.attributes.name = mapUtils.toHTML(this.attributes.name);
      }
...
(function() {
  ...
  exports.Shape = (function() {
    function Shape(id, link, name, val, d) {
      var pair;
      this.id = id;
      this.link = link;
      this.name = name;
      this.val = val;
      this.d = d != null ? d : "";
      this.link = (encodeURI(this.link)).replace(/&/g, "%26");
      this.nextInstruction = "M ";
      this.coordinates = [];
    ...
    Shape.prototype.resetNextInstruction = function() {
      this.nextInstruction = "M ";
      return this.d += "Z ";
    };

    Shape.prototype.addInstruction = function() {
      var ret;
      ret = this.nextInstruction;
      this.nextInstruction = "L ";
      return ret;
    };
    ...
    Shape.prototype.addPoint = function(vector, dx, dy) {
      ...
      try {
        ...
        this.d += this.addInstruction() + x + " " + y + " ";
    ...
    Shape.prototype.addArc = function(vector, dx, dy) {
      ...
      try {
        ...
        try {
          ...
          this.d += this.addInstruction() + xa + " " + ya + " A " + r1 + " " + r2 + " " + (-angle) + " 0 " + sweep + " " + xb + " " + yb + " ";
        } catch (_error) {
          err = _error;
          this.d += this.addInstruction() + xa + " " + ya + " L " + xc + " " + yc + " L " + xb + " " + yb + " ";
        }
    ...
    Shape.prototype.addPie = function(vector, dx, dy) {
      ...
      try {
        ...
        this.d += this.addInstruction() + xa + " " + ya + " A " + r + " " + r + " 0 " + large + " 1 " + xb + " " + yb + " ";
...
(function() {
  ...
  exports.generateMap = function(config, zones) {
    var alternateColor, bg, d, dashboardLink, dashboardLinkText, dashboardSatisfaction, dashboardTitle, desaturation, desaturationFilter, halfDown, halfUp, i, image, initialColor, innerPattern, line, n1, n2, n3, pattern, rectangle, scale, scaleNumbers, svg, value, zone, _i, _j, _k, _len, _ref, _ref1, _ref2, _ref3, _ref4;
    svg = new SVG();
    svg.setAttributes({
      width: config.width,
    ...
    if (((_ref4 = config.styling) != null ? _ref4.length : void 0) > 0) {
      css += "\n" + config.styling;
    }
