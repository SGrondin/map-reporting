...
},{"./Node":1,"./mapUtils":9}],3:[function(require,module,exports){
// Generated by CoffeeScript 1.7.1
(function() {
  ...
  exports.Shape = (function() {
    ...
    Shape.prototype.addToSVG = function(svg, config) {
      ...
      if (config.showIDs && this.coordinates.length > 1) {
...
(function() {
  ...
  exports.setClientScope = function(scope, labels) {
    ...
    scope.emptyDashboard = function() {
      this.head.querySelector("#dashboardTitle").firstChild.nodeValue = this.labels.defaultNoSelect;
