...
(function() {
  var Node, SVG, Shape, embeddedJS, mapUtils, shapeFromStr;
  ...
  shapeFromStr = function(str, config) {
    var id, link, name, shape, val, vectors, _ref;
    _ref = str.split(";"), id = _ref[0], link = _ref[1], name = _ref[2], vectors = _ref[3], val = _ref[4];
  ...
  exports.generateMap = function(config, lines, image) {
    var alternateColor, bg, d, dashboardLink, dashboardLinkText, dashboardSatisfaction, dashboardTitle, desaturation, desaturationFilter, halfDown, halfUp, i, initialColor, innerPattern, line, pattern, svg, textrectangle, value, _i, _j, _k, _len, _ref;
    svg = new SVG();
    svg.setAttributes({
      width: config.width,
